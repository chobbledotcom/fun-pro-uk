---
title: What Is a Batak Game? The Popular Reaction Wall Explained
date: 2026-06-19
author: src/team/colin.md
meta_title: What Is a Batak Game? The Reaction Wall Explained | Fun Pro
meta_description: Wondering what a Batak game is? Discover how the reaction wall
  works, what it's used for, and how to hire one for your next event. A
  friendly, expert guide.
no_index: false
faqs:
  - question: "What is a Batak game? "
    answer: A Batak game is an interactive reaction game built around a panel of
      illuminated targets. Targets light up one at a time and players hit them
      as quickly as possible, with the machine scoring each game automatically.
      It is also known as a reaction wall or reaction trainer.
  - question: How long does a game of Batak last?
    answer: " It depends on the version and the setting chosen. Batak Lite games
      typically run for thirty seconds, while Batak Pro games run for sixty
      seconds. Because each game is so short, you can get a lot of players
      involved over the course of an event."
  - question: "What is the difference between Batak Pro and Batak Lite? "
    answer: Batak Pro is the full-scale version, needs more space, runs sixty-second
      games, and comes with a professional operator. Batak Lite is the compact,
      portable version, suits smaller spaces, and runs thirty-second games. Both
      offer the same fast, competitive gameplay.
  - question: "Is Batak suitable for children? "
    answer: Yes. Batak Lite is suitable for ages eight and up, and the simple
      hit-the-lights format means there is no learning curve. Players compete
      against their own score, so it works well for mixed-age audiences.
  - question: "How much space do you need for a Batak game? "
    answer: Batak Lite needs roughly 1.4m x 1.6m, while Batak Pro works best with a
      clear area of around 3m x 2m to allow room for players and spectators.
      Both are designed for indoor use on a level surface.
  - question: "Can a Batak game be branded with our company logo? "
    answer: Yes. Both Batak Pro and Batak Lite can be customised with your logo,
      corporate colours, or event-specific designs, including branded back
      panels and button surrounds. It is a popular choice for exhibitions and
      brand activations.
  - question: "What is the Batak world record? "
    answer: The Guinness World Record for the most lights extinguished on a Batak
      reaction wall in thirty seconds is held by Formula 1 driver Jenson Button,
...
 This is where most of our clients meet Batak. On an exhibition stand, it is a natural magnet for footfall, drawing people in and giving your team an easy reason to start a conversation. At corporate events and ++[team building days](https://www.funprouk.co.uk/events/team-building-entertainment/)++, it works as an icebreaker that gets colleagues talking and competing in a relaxed way.
...
The good news is that you do not have to manage any of this alone. We handle ++[delivery](https://www.funprouk.co.uk/locations/)++, setup, and collection as part of the hire, and all our equipment is PAT tested and maintained to professional standards. Public liability ++[insurance](https://www.funprouk.co.uk/safety-and-insurance/)++ is included as standard, which is one less thing for you to worry about.

You can also make the game work harder for your brand. Both versions can be ++[customised](https://www.funprouk.co.uk/categories/branded-exhibition-games/)++ with your logo, colours, or event-specific designs, from branded back panels to branded button surrounds, which is particularly popular for exhibitions and ++[brand activations](https://www.funprouk.co.uk/promotional-event-games/)++.

## **Where can you hire a Batak game?**

![](/images/fun-pro-uk-teams.png)
...
If you’re weighing up whether Batak is right for your event, or you simply want to talk through the options, ++[get in touch](https://www.funprouk.co.uk/contact-fun-pro-uk/)++ with our friendly team. We are always happy to discuss your venue, your guest numbers, and what you are hoping to achieve, then recommend the setup that fits.  