...
tabs:
  - title: "Why GIANT BUZZ WIRE?"
    body: "Giant buzz wire scales up the classic steady-hand challenge for event entertainment. Players guide loops along twisted wire without touching, creating tension and drama that draws spectators and generates engagement.


      For events where you want entertainment that creates visible tension and shared moments, buzz wire games deliver. The familiar format needs no explanation whilst the larger scale adds drama.


      With 1-4 player capacity, no power required, and 20-200 guest throughput, it suits most event configurations."
    image: "/images/products/giant-buzz-wire/giant-buzz-wire-15.jpg"
  - title: "How It Works"
    body: "Players guide a loop along the twisted wire path from start to finish without the loop touching the wire. Contact triggers a buzz, marking failure at that point.


      The challenge requires steady hands and patience. Spectators gather to watch, adding pressure to already tense attempts.


      Setup takes approximately 15-20 minutes. The giant format creates more visual impact and drama than tabletop versions."
    image: "/images/products/giant-buzz-wire/giant-buzz-wire-14.jpg"
  - title: "Why It's A Crowd Favourite"
    body: "Buzz wire games create genuine tension that few other formats match. The slow progress, the near-touches, the held breath. The drama is real even though the stakes are low.


      Spectators get drawn into the tension too. Watching someone navigate difficult sections, reacting to close calls, celebrating completions. The shared experience builds atmosphere.


      The scaled-up format adds drama. Giant buzz wire looks impressive and creates more visible entertainment than smaller versions."
    image: "/images/products/giant-buzz-wire/giant-buzz-wire-15.jpg"
  - title: "Delivery"
