...
specs:
  - name: Players
    value: 1-4 players
  - name: Space Required
    value: 0.8m x 1.6m , Allowing for the person to stand in front (W/D)
  - name: Power
    value: No power required
  - name: Setup time
    value: 15-20 minutes
  - name: Equipment Size
    value: 0.6m x 0.6m x 3.1m Height (W/D/H)
  - name: Suitability
...
add_ons:
  intro: >-
    ...
    Make High Striker a powerful marketing tool with full customisation options,
...
tabs:
  ...
  - title: Why It's A Crowd Favourite
    ...
    body: >-
      ...
      strength, so the expected winners don't always triumph. Those upsets
      create the memorable moments that guests talk about afterwards.
  - title: Delivery
...
faqs:
  - question: How many people can play the High Striker at once?
    answer: One player swings at a time, creating focused moments whilst spectators
      watch and anticipate whether they'll ring the bell.
  - question: Is the High Striker suitable for all ages?
    answer: Yes, the classic fairground format suits ages 10 and above. Technique
      matters as much as strength, so results often surprise people.
  - question: How much space do you need?
    answer: The High Striker needs adequate height clearance and surrounding space
      for safe swinging. We'll discuss your venue when you enquire.
