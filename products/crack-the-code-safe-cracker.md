...
categories: ["categories/exhibition-games.md", "categories/prize-games.md", "categories/arcade-games.md", "categories/fun-days.md", "categories/interactive-game-hire.md"]
events: []
featured: true
features:
...
specs:
  ...
  - name: "Power"
    value: "1 x UK power socket (Wattage usage 15 watts)"
  - name: "Setup time"
    value: "TBD"
  - name: "Equipment Size"
...
add_ons:
  intro: |
    ...
    Make Crack The Code safe cracker a powerful marketing tool with full customisation options, including your brand logo, corporate colours, or event-specific designs. Personalising the game ensures a memorable experience for your guests while reinforcing your brand presence.
