...
tabs:
  - title: Why CHRISTMAS GROTTO 2?
    ...
    body: >-
      ...
      experience, creating the kind of magical atmosphere that makes corporate
      Christmas parties memorable. This version offers particular features and
      theming that suits larger or more elaborate setups.


      For events where you want a Christmas centrepiece rather than just
      seasonal decorations, a full grotto delivers the immersive experience that
      creates genuine delight. Photo opportunities, festive atmosphere, and the
      sense of something special distinguish it from standard party setups.


      Setup and theming is handled by our team, transforming your chosen space
      into a festive environment that guests genuinely enjoy experiencing.
  - title: How It Works
    image: /images/products/christmas-grotto-2/christmas-grotto-2-4.jpg
    body: >-
      Our team arrives with all grotto elements and transforms your designated
      space into a Christmas experience. The setup includes theming, lighting,
      and appropriate atmospheric elements.
      ...
      Setup time and space requirements vary by grotto configuration. We'll
      discuss specific needs when you enquire and ensure the setup works for
      your venue.
  - title: Why It's A Crowd Favourite
    image: /images/products/christmas-grotto-2/christmas-grotto-2-5.jpg
    body: >-
      Christmas grottos work because they create genuine atmosphere that
      decorations alone don't achieve. Walking into a properly themed grotto
      feels magical in a way that's hard to explain but easy to experience.


      For corporate Christmas events, this atmosphere matters. It signals that
      thought and effort went into the event, which guests appreciate. The
      photos and memories created are more memorable than standard party snaps.


      There's also an element of permission. A grotto gives adults licence to
      enjoy Christmas in a way they might not feel comfortable doing otherwise.
      That childlike delight improves event atmosphere significantly.
  - title: Delivery
