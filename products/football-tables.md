...
specs:
  - name: Players
    value: 2-4 players
  - name: Space Required
    value: 1.6m x 1.0m , Allowing for the persons to stand either end (D/W)
  - name: Power
    value: No Power required
  - name: Setup time
    value: 15-20 minutes
  - name: Equipment Size
    value: 1.44m x 0.57m x 0.88m (W/D/H)
  - name: Suitability
...
add_ons:
  intro: >-
    ## Table Football Branding and Customisation Options


    Make Table football a powerful marketing tool with full customisation
...
faqs:
  ...
  - question: Is it suitable for all ages?
    answer: Yes, football tables suit ages 8 and above. The familiar format means
      most people can play immediately.
  - question: Do you provide everything needed?
    answer: Yes, balls are included with the table hire. Everything needed for play
      is provided.
