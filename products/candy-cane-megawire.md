...
tabs:
  - title: "Why Candy Cane Megawire?"
    body: "Candy Cane Mega Wire brings festive theming to the classic buzz wire challenge. Players guide a loop along a candy cane shaped wire without touching, creating tension and drama that suits Christmas parties and seasonal corporate events.


      The Christmas theming elevates a proven entertainment format for seasonal appropriateness. For events where you want activities that feel festively considered rather than generic, the seasonal styling makes a difference.
  ...
  - title: "How It Works"
    body: "Players guide a loop along the candy cane shaped wire from start to finish. Touching the wire triggers a festive buzz, adding pressure and creating spectator moments.


      The familiar buzz wire mechanic needs no explanation. The Christmas theming adds seasonal relevance without changing the core challenge.
  ...
  - title: "Why It's A Crowd Favourite"
    body: "Buzz wire games create genuine tension regardless of theming. The careful progress, the held breath, the inevitable touch and resulting buzz. It's drama that emerges naturally.


      The Christmas styling adds value for seasonal events. Entertainment that acknowledges the occasion feels more considered than generic options. Guests notice these details.


      The spectator element is strong too. Colleagues gather, offer advice, react to near-completions. The social dynamics develop without needing to be orchestrated."
    image: "/images/products/candy-cane-megawire/candy-cane-megawire-3.jpg"
  - title: "Delivery"
