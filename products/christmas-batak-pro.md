...
tabs:
  - title: "Why Christmas Batak Pro?"
    body: "Christmas Batak Pro delivers premium reaction gaming with festive theming for Christmas parties and seasonal corporate events. The enhanced pro version offers more challenging gameplay than the standard Batak, suited to events where you want serious competition.
      ...
      For Christmas events where entertainment quality matters as much as seasonal theming, the Pro version delivers both. The faster sequences and more demanding gameplay challenge even experienced players.


      One player at a time creates focused competition, with capacity for 20-200 guests. Setup takes 15-20 minutes with mains power required."
    image: "/images/products/christmas-batak-pro/christmas-batak-pro-9.jpg"
  - title: "How It Works"
    body: "Players face the Batak Pro unit as targets illuminate in rapid succession. The pro version offers faster, more complex patterns that challenge even those familiar with standard Batak.


      Precise scoring tracks performance throughout timed sessions. The Christmas theming adds seasonal atmosphere without reducing the challenge.
  ...
  - title: "Why It's A Crowd Favourite"
    body: "Batak Pro creates more intense competition than standard versions. The increased difficulty means even experienced players are challenged, levelling competition and creating more dramatic moments.


      The Christmas theming makes it seasonally appropriate for festive events. Entertainment that acknowledges the occasion feels more considered than generic alternatives.


      For corporate events with competitive cultures, the Pro version delivers the challenge that keeps achievers engaged. High scores become genuinely impressive."
    image: "/images/products/christmas-batak-pro/christmas-batak-pro-9.jpg"
  - title: "Delivery"
